...
curl -s https://skill-shop-6.preview.emergentagent.com/api/fulfillment/providers/status | python3 -m json.tool

# Test admin health view
curl -s https://skill-shop-6.preview.emergentagent.com/api/fulfillment/admin/providers/health \
...
curl -X POST "https://skill-shop-6.preview.emergentagent.com/api/products/1/redeem" \
...
```bash
export API_URL="https://skill-shop-6.preview.emergentagent.com/api"
```
