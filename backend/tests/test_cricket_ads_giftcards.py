...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://atlas-connection-1.preview.emergentagent.com').rstrip('/')
...
class TestCricketMatches:
    ...
    def test_get_all_matches(self):
        ...
        # Verify T20 Season 2026 data
        assert any("T20" in m.get("series", "") or "Season" in m.get("series", "") for m in data), "Expected T20 Season series matches"
