...
FAQ_ITEMS = [
    {
        "id": "what-are-coins",
        "category": "coins",
        "question": "What are Free Coins?",
        "answer": "Free Coins are non-withdrawable reward tokens that you earn through skill-based cricket predictions and other activities. They can only be redeemed for goods and services from our partner brands. Free Coins are NOT money, NOT cryptocurrency, and cannot be converted to cash or transferred to other users.",
        "priority": 1
    },
    {
        "id": "coins-not-money",
        "category": "coins",
        "question": "Can I withdraw Free Coins as cash?",
        "answer": "No. Free Coins are NOT money and cannot be withdrawn, transferred, or converted to cash under any circumstances. They exist solely as reward tokens for redeeming brand-funded goods and services. This is by design to ensure FREE11 remains a skill-based platform compliant with all regulations.",
        "priority": 2
    },
    {
        "id": "how-earn-coins",
    ...
    },
    {
        ...
        "answer": "No. Free Coins are non-transferable. Each user earns and redeems their own coins independently. This ensures fairness and prevents any form of coin manipulation or trading.",
        "priority": 4
    },
    {
        "id": "what-redeem",
    ...
    },
    {
        "id": "is-predictions",
        "category": "legal",
        "question": "Is FREE11 a predictions or prediction app?",
        "answer": "Absolutely not. FREE11 is a skill-based prediction platform. You earn rewards based on your knowledge and accuracy in predicting cricket outcomes. There is no prediction, no stakes, no cash deposits, and no cash withdrawals. Coins cannot be purchased with money. FREE11 is fully compliant with PROGA (Promotion and Regulation of Online Gaming Act, 2025) guidelines for skill-based gaming.",
        "priority": 7
    },
    {
        "id": "predictions-work",
        ...
        "answer": "During live cricket matches, you predict what will happen on each ball (runs, wicket, wide, etc.). If your prediction is correct, you earn coins. The harder the prediction (like predicting a six or wicket), the more coins you earn. Your prediction accuracy determines your rank on leaderboards.",
        "priority": 8
    },
    {
        "id": "what-clans",
