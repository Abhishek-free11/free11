...
const EMPTY_STATES = {
  dashboard: {
    ...
    description: 'Your journey starts with one prediction.',
  ...
  predictions: {
    ...
    description: 'Your streak starts here — make your first call.',
  ...
  vouchers: {
    ...
    description: 'Your rewards will show up here once you unlock your first one.',
  ...
  transactions: {
    ...
    description: 'Your coin history will appear once you start earning through predictions.',
  ...
  leaderboard: {
    ...
    description: 'Start predicting to join the leaderboard and see where you rank.',
    actionText: 'Start Predicting',
    actionPath: '/cricket',
  },
};
