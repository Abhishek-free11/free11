        ...
        <Card className="mb-8 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-blue-500/30" data-testid="faq-disclaimer-banner">
          <CardContent className="py-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Important: About Free Coins</h3>
                <p className="text-slate-300 text-lg leading-relaxed" data-testid="faq-coin-policy">
                  {faqData?.disclaimer || "Free Coins are non-withdrawable reward tokens redeemable only for goods/services. No cash. No prediction. Brand-funded rewards."}
                </p>
              </div>
            </div>
          </CardContent>
