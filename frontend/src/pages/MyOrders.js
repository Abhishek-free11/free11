...
const MyOrders = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 pb-28 md:pb-4 via-slate-900 to-slate-900">
      <Navbar />
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-7xl" data-testid="orders-page">
        <div className="mb-8">
          ...
          <p className="text-slate-300">Track your redemptions and deliveries</p>
        </div>

        {orders.length > 0 ? (
          <div className="space-y-4">
            {orders.map((order) => (
              <Card key={order.id} className="bg-slate-800/70 border-slate-700" data-testid={`order-${order.id}`}>
                <CardHeader>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div>
                      <p className="text-sm text-slate-300">Coins Spent</p>
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-bold text-slate-300 mb-2">No orders yet</h3>
